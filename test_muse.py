...
async def start_and_manage_stream(address):
    muse = Muse(address)
    await muse.connect()
    await muse.start(stream_types=['eeg'])
...
async def main_async():
    ...
    if target_muse:
        ...
        stream_task = asyncio.create_task(start_and_manage_stream(target_muse['address']))
